...
import { MapPin, Clock, Users, Star, ArrowRight, Filter, Search } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
              Explore our complete collection of carefully crafted travel experiences. From heritage tours to adventure expeditions, find your perfect journey.
            </p>
            <button
